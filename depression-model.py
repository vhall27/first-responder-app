...
def logistic_regression_trainer():
  with open('csv-files/Mental-Illness-Train-Depression.csv', mode='r', newline='') as file:
...
def logistic_regression_tester(theta_list):
  with open('csv-files/Mental-Illness-Test-Depression.csv', mode='r', newline='') as file:
    csv_reader = csv.reader(file)
    header = next(csv_reader)
...
def give_user_prediction(theta_list):
  ...
  if sigmoid >= 0.85:
    print("Very High Possibility of Depression Disorder")
  elif sigmoid >= 0.6:
    print("High Possibility of Depression Disorder")
  elif sigmoid >= 0.4:
    print("Moderate Possibility of Depression Disorder")
  else:
    print("Low Possibility of Depression Disorder")
...
def calibration_curve(theta_list, test_rows, n_bins=10):
    ...
    """
    # Collect predicted probabilities and actual labels
    probs = []
    labels = []
